 ...
 */
void plot(const plotdata_ref x, const plotdata_ref y, const char *label);

/**
 * Plot x..y data, specify label and curve colour
 */
void plot(const plotdata_ref x, const plotdata_ref y, const char *label, int colour);

/**
 * Plot x..y data, specify curve colour, then label
 */
void plot(const plotdata_ref x, const plotdata_ref y, int colour, const char *label);
 ...
 */
void plot(const plotdata_ref x, func_ref f, const char *label);

/**
 * Plot f(x) function, specify label and curve colour (use together with f(x) function)
 */
void plot(const plotdata_ref x, func_ref f, const char *label, int colour);

/**
 * Plot f(x) function, specify curve colour, then label (use together with f(x) function)
 */
void plot(const plotdata_ref x, func_ref f, int colour, const char *label);
